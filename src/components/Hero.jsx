    ...
    <section className='relative w-full h-screen mx-auto'>
      <div className={`absolute ${styles.paddingX} inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText}`}>Desarrollador Web, <br className='sm:block hidden' /> Full Stack</p>
        </div>
      </div>
      <ComputersCanvas />

      <div className='absolute xs:bottom-10 bottom-[12rem] w-full flex justify-center items-center'>
        <a href='#about'>
